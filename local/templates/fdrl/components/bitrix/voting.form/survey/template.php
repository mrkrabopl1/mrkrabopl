<?if (!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)die();?><?=ShowError($arResult["ERROR_MESSAGE"]);?>
...
<?php $countAn=1;?>
    <div class="checklist__info-cont container">
        <p class="checklist__prefer-big-text"><?= $arResult["VOTE"]["TITLE"];?></p>
        <p class="checklist__go-test-text"><?=$arResult["VOTE"]["DESCRIPTION"];?></p>
        <p class="checklist__questions"><? $countQuest+=1;?><?= $countQuest;?>.<?= ($arResult["QUESTIONS"]["$countQuest"]["QUESTION"]);?></p>
        <label class="checklist__checkbox-other">
            <input type="radio" name="pip" >
            <span class="checklist__answer"><?= ($arResult["QUESTIONS"]["$countQuest"]["ANSWERS"]["$countAn"] ["MESSAGE"]);?><?php $countAn+=1;?></span>
        </label>
        <label class="checklist__checkbox-other">
            <input type="radio" name="pip" >
            <span class="checklist__answer"><?= ($arResult["QUESTIONS"]["$countQuest"]["ANSWERS"]["$countAn"] ["MESSAGE"]);?><?php $countAn+=1;?></span>
        ...
        <label class="checklist__checkbox-other">
            ...
            <span class="checklist__answer"><?= ($arResult["QUESTIONS"]["$countQuest"]["ANSWERS"]["13"] ["MESSAGE"]);?><?php $countAn+=1;?></span>
        </label>
        <label class="checklist__checkbox-other">
            <input type="radio" name="pip2" >
            <span  class="checklist__answer"><?= ($arResult["QUESTIONS"]["$countQuest"]["ANSWERS"]["14"] ["MESSAGE"]);?><?php $countAn+=1;?></span>
        </label>
        <label class="checklist__checkbox-other">
            <input type="radio" name="pip2" >
            <span class="checklist__answer"><?= ($arResult["QUESTIONS"]["$countQuest"]["ANSWERS"]["15"] ["MESSAGE"]);?><?php $countAn+=1;?></span>
        </label>
        <p class="checklist__questions"><? $countQuest+=1;?><?= $countQuest;?>.<?= ($arResult["QUESTIONS"]["$countQuest"]["QUESTION"]);?></p>
        <label class="checklist__checkbox-other">
            <input type="radio" name="pip3" >
            <span class="checklist__answer checklist__answer_padding-top"><?= ($arResult["QUESTIONS"]["$countQuest"]["ANSWERS"]["8"] ["MESSAGE"]);?><?php $countAn+=1;?></span>
        </label>
        <label class="checklist__checkbox-other">
            <input type="radio" name="pip3" >
            <span class="checklist__answer checklist__answer_padding-top"><?= ($arResult["QUESTIONS"]["$countQuest"]["ANSWERS"]["11"] ["MESSAGE"]);?><?php $countAn+=1;?></span>
        </label>
        <label class="checklist__checkbox-other checklist__checkbox-other_width">
            <input type="radio" name="pip3" >
            <span class="checklist__answer checklist__answer_margin checklist__answer_padding-top"><?= ($arResult["QUESTIONS"]["$countQuest"]["ANSWERS"]["9"] ["MESSAGE"]);?><?php $countAn+=1;?></span>
        </label>
        <br>
        <label class="checklist__checkbox-other  ">
            <input type="radio" name="pip3" >
            <span class="checklist__answer checklist__answer_padding-top " ><?= ($arResult["QUESTIONS"]["$countQuest"]["ANSWERS"]["10"] ["MESSAGE"]);?><?php $countAn+=1;?></span>
        </label>
        <label class="checklist__checkbox-other checklist__checkbox-other_width">
            <input type="radio" name="pip3" >
            <span class="checklist__answer checklist__answer_margin checklist__answer_padding-top"><?= ($arResult["QUESTIONS"]["$countQuest"]["ANSWERS"]["12"] ["MESSAGE"]);?><?php $countAn+=1;?></span>
        </label>
